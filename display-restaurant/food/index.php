      ...
      <div class="row w-80 t-center">
        ...
        <div class="row ">
          <div class="col-md-6 food-wrap">
            ...
            <div class="body-food-description">
              <h4 class="name-food">Hot Pizza</h4>
              <h4 class="price-food">$2.00</h4>
              <p class="food-description">Pizza with Ham, Pineapple and lots of Cheese</p>
          ...
          <div class="col-md-6 food-wrap">
            ...
            <div class="body-food-description">
              <h4 class="name-food">Best Mo Mo</h4>
              <h4 class="price-food">$6.00</h4>
              <p class="food-description">Mo Mo with Ham, Pineapple and lots of Cheese</p>
              <a href="#"><button class="style-btn order-btn">Order Now</button></a>
            </div>
            <div class="clear"></div>
          </div>
        ...
        <div class="row ">
          ...
          <div class="col-md-6 food-wrap">
            <img src="./img/menu-pizza.jpg" alt="pizza" class="img-food">
            <div class="body-food-description">
              <h4 class="name-food">Best Pizza</h4>
              <h4 class="price-food">$4.00</h4>
              <p class="food-description">Pizza with Ham, Pineapple and lots of Cheese</p>
              <a href="#"><button class="style-btn order-btn">Order Now</button></a>
            </div>
        ...
        <div class="row ">
          ...
          <div class="col-md-6 food-wrap">
            <img src="./img/menu-pizza.jpg" alt="pizza" class="img-food">
            <div class="body-food-description">
              <h4 class="name-food">Pizza Squid</h4>
              <h4 class="price-food">$10.00</h4>
              <p class="food-description">Pizza with Ham, Pineapple and lots of Cheese</p>
              <a href="#"><button class="style-btn order-btn">Order Now</button></a>
            </div>
            <div class="clear"></div>
